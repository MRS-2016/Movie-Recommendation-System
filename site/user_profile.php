...
<font face="sans-serif" size="3" align="left" color="white"> Date - <?php print date('D, d M Y '); ?></font>
	...
	<div class="full">
		...
		<div class="col-md-9 main">
						...
						<tr><td align="center"><b>User Name </th><td>:</td><td align="center"><?php echo $u_name?></td></tr>
						<tr><td align="center"><b>Name </th><td>:</td><td align="center"><?php echo $f_name." ".$l_name?></td></tr>
						<tr><td align="center"><b>E mail </th><td>:</td><td align="center"><?php echo $email?></td></tr>
						</table>
						<hr id = "id1">
						...
						<!--PHP CODE FOR PAGING-->
							<?php
							$per_page = 12;
							$pages_query = mysql_query("Select count('ID') from item_rating where user_id = '$user_id'");
							...
							if(!($page <= 1)){
							   echo "<li><a href='user_profile.php?page=$prev' style='text-decoration:none'>Prev </a></li> ";
							}
							if($pages >= 1)
							{
				...
				if(!($page >= $pages)){
					echo "<li><a href='user_profile.php?page=$next' style='text-decoration:none'>Next</a></li></ul> ";
					}
				?>
						<br><br><hr id = "id2">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<?php 
						//echo $user_id; //To Show the user id of the current login
						$sql = mysql_query("SELECT * FROM item_rating where user_id = '$user_id' limit $start,$per_page ");
						
						while($row = mysql_fetch_object($sql))
 			{
		?>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="movie">
								<figure class="movie-poster"><img width="75" height="75" src="img/<?= $row->movie_ID ?>.jpg" /></figure>
								<div class="movie-title"><a href="layout_review.php?ide=<?= $row->movie_ID ?>"><?= $row->title ?></a></div>
