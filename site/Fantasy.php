	...
	<div class="full">
		...
		<div class="col-md-9 main">
						...
						<div class="filters"><br>
							...
							<?php
							$per_page = 12;
							$pages_query = mysql_query("Select count('ID') from movies WHERE genres like '%Fantasy%'");
							...
							if(!($page <= 1)){
							   echo "<li><a href='Fantasy.php?page=$prev' style='text-decoration:none'>Prev </a></li> ";
							}
							if($pages >= 1)
							{
				...
				if(!($page >= $pages)){
					echo "<li><a href='Fantasy.php?page=$next' style='text-decoration:none'>Next</a></li></ul> ";
					}
				?>
				</form>
				</div>
				...
				<?php
					...
					//$g = $_GET['genre'];
					//echo $id;
					$sql = mysql_query("SELECT * FROM movies WHERE genres like '%Fantasy%' limit $start,$per_page") or die("<br><br><br><br><br><br><br><br><br><h1><center>No Movies Found.<br>More Movies To Come Stay Tune..........</center></h1>");
