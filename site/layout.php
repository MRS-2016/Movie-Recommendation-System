	...
	<div class="full">
		...
		<div class="col-md-9 main">
						...
						<form action="view_movies.php" method="POST">
							<select name="genre" id="genre" placeholder="Choose Category">
					...
					<?php
							...
							<button type="submit" value="Submit" class="button">Search Movies</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<!--PHP CODE FOR PAGING-->
							<?php
							$per_page = 24;
							$pages_query = mysql_query("Select count('ID') from movies");
							...
							if(!($page <= 1)){
							   echo "<li><a href='layout.php?page=$prev' style='text-decoration:none'>Prev </a></li> ";
							}
							if($pages >= 1)
							{
				...
				if(!($page >= $pages)){
					echo "<li><a href='layout.php?page=$next' style='text-decoration:none'>Next</a></li></ul> ";
					}
				?>
				</form>
				</div>
				...
				<?php
					$sql = mysql_query("SELECT * FROM movies ORDER BY RAND() limit $start,$per_page") or die("<br><br><br><br><br><br><br><br><br><h1><center>No More Movies.<br>More Movies To Come Stay Tune..........</center></h1>");
