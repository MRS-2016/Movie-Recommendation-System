...
sys.path.insert(0, '/media/windows7/MRS/MRS')
...
html_theme_path = ['/media/windows7/MRS/MRS/docs/alabaster-0.7.6/']
...
latex_documents = [
  ('index', 'user_guide.tex', u'MRS Documentation',
   u'Abhisek-', 'manual'),
]
